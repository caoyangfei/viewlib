...
import com.flyang.expandview.refresh.around.internal.path.PathsDrawable;
...
public class DropBoxHeader extends SimpleComponent implements RefreshHeader {
    ...
    public DropBoxHeader(Context context, @Nullable AttributeSet attrs) {
        ...
        } else if (ta.hasValue(R.styleable.DropBoxHeader_refreshDrawable1)) {
            mDrawable1 = ta.getDrawable(R.styleable.DropBoxHeader_refreshDrawable1);
        } else {
...
//            drawable1.printOriginal("drawable1");
        ...
        } else if (ta.hasValue(R.styleable.DropBoxHeader_refreshDrawable2)) {
            mDrawable2 = ta.getDrawable(R.styleable.DropBoxHeader_refreshDrawable2);
        } else {
...
//            drawable2.printOriginal("drawable2");
        ...
        } else if (ta.hasValue(R.styleable.DropBoxHeader_refreshDrawable3)) {
            mDrawable3 = ta.getDrawable(R.styleable.DropBoxHeader_refreshDrawable3);
        } else {
