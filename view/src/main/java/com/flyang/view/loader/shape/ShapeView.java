package com.flyang.view.loader.shape;
...
public class ShapeView extends View {
    ...
    private void init() {
        ...
        mTriangleColor = getResources().getColor(R.color.color_aa72d572);
        mCircleColor = getResources().getColor(R.color.color_aa738ffe);
        mRectColor = getResources().getColor(R.color.color_aa72d572);
    }
        ...
        switch (mShape) {
            ...
            case SHAPE_RECT:
                ...
                if (mIsLoading) {
                    ...
                    mPaint.setColor(getResources().getColor(R.color.color_aae84e40));
