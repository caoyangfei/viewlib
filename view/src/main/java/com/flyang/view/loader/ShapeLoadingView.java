...
import com.flyang.view.loader.shape.ShapeView;


/**
 * @author 曹阳飞
 * @ClassName ShapeLoadingView
 * @date 2017/11/17
 * ------------- Description -------------
 * 自由落体加载动画
 */
public class ShapeLoadingView extends FrameLayout {
    ...
    public void upThrow() {
        ...
        ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(mShapeView, "translationY", mDistance, 0);
    ...
    public void freeFall() {
        ...
        ObjectAnimator objectAnimator = ObjectAnimator.ofFloat(mShapeView, "translationY", 0, mDistance);
