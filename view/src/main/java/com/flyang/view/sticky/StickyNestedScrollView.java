package com.flyang.view.sticky;
...
/**
 * @author caoyangfei
 * @ClassName StickyNestedScrollView
 * @date 2019/9/30
 * ------------- Description -------------
 * 吸顶滑动
 * <p>
 * 控件设置tag
 * {@link StickyNestedScrollView#STICKY_TAG,StickyNestedScrollView#FLAG_NONCONSTANT,StickyNestedScrollView#FLAG_HASTRANSPARENCY}
 */
public class StickyNestedScrollView extends NestedScrollView {
    ...
    //设置固定绘制的控件 e.g. TextViews, ImageViews etc
    public static final String STICKY_TAG = "sticky";

    //设置不是固定绘制的控件 e.g. Buttons, ProgressBars etc
