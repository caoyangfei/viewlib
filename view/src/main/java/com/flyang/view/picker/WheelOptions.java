...
import com.flyang.view.picker.listener.OnOptionsSelectChangeListener;
import com.flyang.view.picker.view.WheelView;

import java.util.List;

public class WheelOptions<Fst, Snd, Trd> {
    private View view;
    private WheelView wv_option1;
    private WheelView wv_option2;
    private WheelView wv_option3;

    private List<Fst> mOptions1Items;
    private List<List<Snd>> mOptions2Items;
    private List<List<List<Trd>>> mOptions3Items;
    ...
    //不联动情况下
    public void setNPicker(List<Fst> options1Items, List<Snd> options2Items, List<Trd> options3Items) {
