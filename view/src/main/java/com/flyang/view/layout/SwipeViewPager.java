 ...
 * 所以在一起使用时会有冲突，
 * 使用本控件(SwipeViewPager)，可以在ViewPager的第一页使用左滑。在ViewPager的最后一页使用右滑菜单。
 * <p>
 * @see <a href="https://github.com/mcxtzhang/SwipeDelMenuLayout">mcxtzhang@github</a>
 */
