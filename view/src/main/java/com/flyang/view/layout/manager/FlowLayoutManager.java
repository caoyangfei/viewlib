...
import com.flyang.view.layout.flow.CommonLogic;
import com.flyang.view.layout.flow.ConfigDefinition;
import com.flyang.view.layout.flow.LineDefinition;
import com.flyang.view.layout.flow.ViewDefinition;
...
/**
 * @author caoyangfei
 * @ClassName FlowLayoutManager
 * @date 2019/6/8
 * ------------- Description -------------
 * 子布局管理，可以设置子空间左右margin等
 *
 */
